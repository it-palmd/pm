...
// <img src='images/symptom/".$rs->repair_symptom_pic."' alt='Symptom Pic' class='symptom_pic'>
      $txt = "
      <a href='job_detail.php?job_code=".$rs->repair_code."' class='list-group-item list-group-item-action border-1'>
      <img src='images/".($rs->repair_symptom_pic=='' ? $symptom_pic = 'sparepart/' . $rs->spare_code. '.jpg' : $symptom_pic = 'symptom/' . $rs->repair_symptom_pic)."' class='symptom_pic' alt='ไม่มีรูป'>
