      ...
      <div id="top" class="">
        <div class="clearfix text-center panel panel-info">
            <div class="panel-heading">
              <h4 class="alert alert-info">งานซ่อมเดือนนี้</h4>
              <h5 class="text-center text-info"><?php echo $date ?></h5>
            </div>
        </div>
      </div>
<!-- End Top Panel -->
            ...
            <input type="hidden" name="job_code" id="h_job_code">
              ...
              <div class="form-group text-left search_control">
                <small for="order_by" class="text-muted">เรียงตาม</small>
                  <select class="input-lg form-control text-center" id="order_by" name="order_by" onchange="get_month_job($('#where').val(), this.value)">
              ...
              <div class="form-group search_control">
                <small for="where" class="text-muted">กลุ่มช่าง</small>
                  <select class="input-lg form-control text-center" id="where" name="where" onchange="get_month_job(this.value, $('#order_by').val())">
