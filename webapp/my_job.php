      ...
      <div id="top" class="">
        <div class="clearfix text-center panel panel-info">
            <div class="panel-heading">
              <h4 class="alert alert-warning">งานซ่อมของฉัน</h4>
            </div>
        </div>
      </div>
<!-- End Top Panel -->
            ...
            <div class="form-group">
              ...
              <div class="form-group text-left">
                ...
                <div class="form-inline">
                  <select class="input-lg form-control text-center" id="sort_order" name="sort_order" onchange="get_my_job(this.value)" style="width:100%;">
