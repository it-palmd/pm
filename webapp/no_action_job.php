      ...
      <div id="top" class="">
        <div class="clearfix text-center panel panel-info">
            <div class="panel-heading">
              <h4 class="alert alert-danger">งานซ่อมค้าง</h4>
            </div>
        </div>
      </div>
<!-- End Top Panel -->
          ...
          <form method="post" action="">
            ...
            <div class="form-group text-left search_control">
              <small for="order_by" class="text-muted">เรียงตาม</small>
                <select class="input-lg form-control text-center" id="order_by" name="order_by" onchange="get_no_action_job($('#where').val(), this.value)">
            ...
            <div class="form-group search_control">
              <small for="where" class="text-muted">กลุ่มช่าง</small>
                <select class="input-lg form-control text-center" id="where" name="where" onchange="get_no_action_job(this.value, $('#order_by').val())">
...
<!-- end content -->
    ...
    function get_no_action_job(where, order_by){

      var username = $('.user').text();
      var level = $('.level').text();

        $.ajax({
          url: 'get_no_action_job_list.php',
          method: 'post',
