...
<div id="control_event" class="control_event">
      ...
      <div class="clearfix text-center panel panel-info">
          <div class="panel-heading"><h4><span class="glyphicon glyphicon-file" aria-hidden="true"></span>รายงานการแจ้งซ่อมตามช่วง วัน เดือน ปี</h4></div>
      </div>
  ...
  <!-- Begin panel-body -->
              <div class="panel-body">
                <p>ผู้ใช้สามารถเรียกดูข้อมูลใบแจ้งซ่อมในระบบได้ ตามคำที่ต้องการค้นหา และยังสามารถปริ้นเอกสารตามที่ค้นหาได้เพื่อใช้ในการทำงานอื่นๆ</p>
            ...
            <div id="control_container">
              ...
              <div class="control_box_lr" style="text-align:left;">
                ...
                <div class="control_box_c text-center">
                  ...
                  <h5>ระหว่างวันที่ <span id="s_date"></span> ถึงวันที่ <span id="e_date"></span></h5>
                </div>
...
// $(".dataTables_length").hide();
  ...
  fetch_data(dateString, dateString);
...
// var end_date = d[1];
 ...
 var dataTable = $('#p_data').DataTable({
   ...
   "pagingType": "full_numbers", //แสดงปุ่ม paginage แบบเต็ม
    ...
    "ajax" : {
       url:"report/fetch_between_report.php",
       type:"POST",
