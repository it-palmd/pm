...
<div id="control_event" class="control_event">
      ...
      <div class="clearfix text-center panel panel-info">
          <div class="panel-heading"><h4><span class="glyphicon glyphicon-file" aria-hidden="true"></span>รายงานการแจ้งซ่อมแยกตามกลุ่มช่าง</h4></div>
      </div>
  ...
  <!-- Begin panel-body -->
              <div class="panel-body">
                <p>ระบุเงื่อนไข กลุ่มช่างที่ต้องการ และตาม ระบุวันที่ต้องการ ทุกครั้งเพื่อเรียกดูรายงาน</p>
                  ...
                  <input type="hidden" name="end_date" id="end_date" />
                    ...
                    <div class="form-group" style="padding:15px;">
                        ...
                        <div class="col-12 text-center">
                          <small for="tech_group" class="text-muted">กลุ่มช่าง</small>
                          <div class="form-inline">
                            <select class="form-control col-12 text-center mr-1" style="width:250px;" id="tech_group" name="tech_group" onchange="updateText(this.value); fetch_data(this.value, $('#start_date').val(), $('#end_date').val());" required>
                        ...
                        <div class="form-group text-center">
                          ...
                          <div class="form-inline">
                            <input type="text" class="form-control col-12 text-center mr-1" id="date_range" name="date_range" style="width:250px;" onblur="validate(this.value)">
                          </div>
                        </div>
  ...
  <!-- End panel-body -->
              ...
              <div class="panel-footer">
                ...
                <button type="button" id="btn_print" class="btn btn-info" onclick="window.print()" disabled>
