...
/* For Print */
      @media print {
        ...
        .print_panel { width: 100%!important; margin:0px auto!important; }
        .control_nav, #control_event { display: none!important; }
        #header_print, #p_iso_start_use { display: block!important; }
        #daily_repair { margin-bottom: 75px auto 0px!important; width: 100%!important; }
        #dep_total_persen, #month_total_persen, #equal_total_persen { font-size: 30px!important; padding: 20px 0!important; }
        /* #chartKPI_SPLINE { height: 369px!important; } */
      }
...
/* End for Print */
      ...
      #p_iso_start_use { display: none; } */
      #chartKPI_ALL { width: 30%; }
      #dep_total_persen, #month_total_persen, #equal_total_persen { font-size: 80px; padding: 20px 0; }
      /* #chartKPI_SPLINE { width: 100%;"} */
      select { width:250px!important; }


      @media screen and (min-width: 900px) {
        #dep_total_persen, #month_total_persen, #equal_total_persen { font-size: 30px; padding: 20px 0; }
        .col-sm-3, .col-md-3, .col-sm-6, .col-md-6, .col-sm-12, .col-md-12 { font-size: 100%; padding: 0px; }
      }
      ...
      @media screen and (max-width: 769px) {
        ...
        #dep_total_persen, #month_total_persen, #equal_total_persen { font-size: 40px!important; padding: 20px 0; }
      ...
      @media screen and (max-width: 423px) {
        #daily_repair { display: none }
        .print_panel { width: 100%; }
        .col-sm-3, .col-md-3, .col-sm-6, .col-md-6, .col-sm-12, .col-md-12 { font-size: 100%; padding: 5px; }
...
<!-- End control_event -->
          ...
          <div id="" class="print_panel clearfix" style="clear:both;">
                ...
                <div class="panel panel-waring text-center" style="border-color: #8a6d3b">
                  <div class="panel-body">
                    ...
                    <div class="text-left" style="">
                      ...
                      <div class="text-left col-xs-6 col-sm-6 col-md-6">ปิด</div><div id="dep_close" class="text-right col-xs-6 col-sm-6 col-md-6">0</div>
                      <div class="text-left col-xs-6 col-sm-6 col-md-6">ค้าง</div><div id="dep_progress" class="text-right col-xs-6 col-sm-6 col-md-6">0</div>
                    </div>
                  </div>
              ...
              <div class="col-sm-2 col-md-2">
                <div class="panel text-center" style="border-color: #999999">
                  <div class="panel-body">

                    <p id="equal_total_persen" style="">0%</p>

                    <div class="text-left" style="">
                      <strong><div class="text-left col-xs-6 col-sm-6 col-md-6">ทั้งหมด</div><div id="equal_total" class="text-right col-xs-6 col-sm-6 col-md-6">0</div></strong>
                      <div class="text-left col-xs-6 col-sm-6 col-md-6">ปิด</div><div id="equal_close" class="text-right col-xs-6 col-sm-6 col-md-6">0</div>
                      <div class="text-left col-xs-6 col-sm-6 col-md-6">ค้าง</div><div id="equal_progress" class="text-right col-xs-6 col-sm-6 col-md-6">0</div>
                    </div>
                  </div>
                  <div class="panel-footer" style="background: #999999; color: #ffffff;"><h4>รวมยอดยกมา</h4></div>
                </div>
              </div>
                ...
                <div class="panel panel-primary text-center">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="text-left" style="">
                      ...
                      <div class="text-left col-xs-6 col-sm-6 col-md-6">ปิด</div><div id="month_close" class="text-right col-sm-6 col-xs-6 col-md-6">0</div>
                      <div class="text-left col-xs-6 col-sm-6 col-md-6">ค้าง</div><div id="month_progress" class="text-right col-xs-6 col-sm-6 col-md-6">0</div>
                    </div>
                  </div>
              ...
              <div class="col-sm-6 col-md-6">
                <div id="chartKPI_PIE" style="height: 400px; margin-bottom: 40px;"></div>
                <button class="btn invisible" id="backButton">&lt; Back</button>
              </div>

              <div id="daily_repair" class="col-sm-12 col-md-12" style="margin-bottom: 75px;"></div>
              ...
              <div id="p_iso_start_use" class="control_box_lr" style="text-align:left; width:350px!important; font-size: 10px; position: fixed; bottom: 0;">
                  <p>วันที่เริ่มใช้งาน: 1 ส.ค. 2559  แก้ไขครั้งที่: 00</p>
              </div>
...
//ออกจากระบบ
    ...
    // $(".dataTables_length").hide();
      ...
      var s_tech_group = $('#tech_group').val('TMECH'); //$("select[name='tech_group'] option:selected");
...
function fetch_data(tech_group, month, year)
{
  ...
  get_data('equal_total', tech_group.val(), month.val(), year.val());
  get_data('equal_close', tech_group.val(), month.val(), year.val());
  get_data('equal_progress', tech_group.val(), month.val(), year.val());
  get_data('equal_total_persen', tech_group.val(), month.val(), year.val());
...
function get_data(action, tech_group, month, year){
    ...
    $.ajax({
      ...
      success:function(response){
        ...
        if(action == 'daily_repair' || action == 'dep_total_persen' || action == 'month_total_persen' || action == 'equal_total_persen'){
