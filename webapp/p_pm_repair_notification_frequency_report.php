...
<div id="control_event" class="control_event">
      ...
      <div class="clearfix text-center panel panel-info">
          <div class="panel-heading"><h4><span class="glyphicon glyphicon-file" aria-hidden="true"></span>รายงาน ความถี่ในการแจ้งซ่อมของเครื่องจักร</h4></div>
      </div>
...
<!-- End control_event -->
          ...
          <div id="" class="print_panel clearfix" style="clear:both;display:none; margin:0px;">
            ...
            <div id="control_container">
              ...
              <div class="control_box_lr" style="text-align:left;">
                ...
                <div class="control_box_c text-center">
                  <h4>รายงานแสดงความถี่ในการแจ้งซ่อมของเครื่องจักร</h4>
            ...
            <div id="p_iso_start_use" class="control_box_lr" style="text-align:left; width:350px!important;">
                <p>วันที่เริ่มใช้งาน: 4 พฤษภาคม 2562 แก้ไขครั้งที่: 01</p>
            </div>
            ...
            var dataTable = $('#p_data').DataTable({
              ...
              "pagingType": "full_numbers", //แสดงปุ่ม paginage แบบเต็ม
               ...
               "columnDefs": [
                            ...
                            { "width": "9%", "targets": 1, "class": "text-center" },
                            { "width": "55%", "targets": 2 },
                            { "width": "25%", "targets": 3 },
                            { "width": "15%", "targets": 4, "class": "text-center" }
                          ],
               "ajax" : {
                  url:"report/fetch_repair_notification_frequency_report.php",
                  type:"POST",
