      ...
      <div id="top" class="">
        <div class="clearfix text-center panel panel-info">
            <div class="panel-heading">
              <h4 class="alert alert-info">งานซ่อมรอช่างรับงาน</h4>
            </div>
        </div>
      </div>
<!-- End Top Panel -->
            ...
            <div class="form-group">
              ...
              <div class="form-group text-left">
                ...
                <div class="form-inline">
                  <select class="input-lg form-control text-center" id="where" name="where" onchange="get_wait_technician_job(this.value)" style="width:100%">
...
<!-- End Bottom Panel -->
    ...
    function get_wait_technician_job(where){

      var username = $('.user').text();
      var level = $('.level').text();

        $.ajax({
          url: 'get_wait_technician_job_list.php',
          method: 'post',
